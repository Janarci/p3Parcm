...
void Runner::run()
{
	...
	//objLoader* loader = new objLoader(modelTransformLoc, this);
	//loader->onStartTask();
	...
	for (int i = 0; i < 1; i++)
	{
		std::cout << "making threads here" << std::endl;
		PoolWorkerThread* RTThread = new PoolWorkerThread(i, 0);
...
void Runner::onFinishedExecution()
{
